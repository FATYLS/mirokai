...
export default function Validation4Page() {
    ...
    <main className="relative flex min-h-[100svh] w-full flex-col overflow-hidden">
      ...
      <div className="relative z-10 mt-4 flex flex-1 flex-col items-center">
        <motion.div
          ...
          className="relative h-[340px] w-full max-w-[380px]"
        >
          <motion.div
            aria-hidden
            animate={{ rotate: 360 }}
          ...
          <div className="absolute left-1/2 top-1/2 h-[68%] w-[34%] -translate-x-1/2 -translate-y-1/2">
            <Image
              src="/images/buste-robot.png"
              alt="Buste du Mirokaï robot"
              fill
              priority
              sizes="160px"
        ...
        <motion.h1
          ...
          className="mt-1 font-display text-[44px] font-black tracking-[-0.02em] text-text-primary"
        >
          EXCELLENT !
        </motion.h1>
        ...
        >
          ...
          <br />
          Grâce à toi, les Mirokaï comprennent mieux le monde qui les entoure.
        </motion.p>
        ...
        >
          <PrimaryButton onClick={() => router.push("/final")}>
            Suivant
          </PrimaryButton>
        </motion.div>
      </div>
