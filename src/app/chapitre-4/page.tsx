    ...
    <main className="relative min-h-[100svh] w-full overflow-x-hidden">
      ...
      >
        <div className="relative aspect-[400/285] w-full overflow-hidden rounded-3xl border-2 border-[color:var(--rose-20)]">
          <Image
            src="/images/chapter4-hero.jpg"
            alt="Chapitre 4 — La mission sur terre"
            fill
            priority
            sizes="400px"
      ...
      >
        <p className="text-[15px] leading-[1.5] text-text-primary">
          ...
          peut accomplir sa mission&nbsp;: rejoindre les humains et leur
          apporter son aide.
        </p>
      </motion.section>
      ...
      >
        <PrimaryButton onClick={() => router.push("/mission-4")}>
          Suivant
        </PrimaryButton>
      </motion.section>
    </main>
