...
export default function Validation2Page() {
      ...
      <div className="relative z-10 mt-4 flex flex-1 flex-col items-center">
        ...
        >
          ...
          <div className="absolute left-1/2 top-1/2 h-[70%] w-[52%] -translate-x-1/2 -translate-y-1/2">
            <Image
              src="/images/robot-legs.png"
              alt="Jambe du Mirokaï robot"
              fill
              priority
              sizes="220px"
        ...
        >
          ...
          <br />
          Grâce à toi, les Mirokaï savent maintenant se déplacer sur Terre.
        </motion.p>
        ...
        >
          <PrimaryButton onClick={() => router.push("/quests-3")}>
            Épreuve suivante
          </PrimaryButton>
        </motion.div>
      </div>
