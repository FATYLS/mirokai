...
export default function Validation3Page() {
    ...
    <main className="relative flex min-h-[100svh] w-full flex-col overflow-hidden">
      ...
      <div className="relative z-10 mt-4 flex flex-1 flex-col items-center">
        ...
        >
          ...
          <div className="absolute left-1/2 top-1/2 h-[70%] w-[52%] -translate-x-1/2 -translate-y-1/2">
            <Image
              src="/images/robot-arms.png"
              alt="Bras du Mirokaï robot"
              fill
              priority
              sizes="200px"
        ...
        >
          <PrimaryButton onClick={() => router.push("/quests-4")}>
            Suivant
          </PrimaryButton>
        </motion.div>
      </div>
